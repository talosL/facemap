    ...
    <div class="superCtab">
        ...
        <div class="ctab-Main">
            <div class="ctab-Main-title">
                <ul class="clearfix">
                    <li><a href="{{url('guest_manager_ac')}}">已识别访客</a></li>
                    <li class="cur"><a href="{{url('guest_manager_str')}}">陌生访客</a></li>
                </ul>
            </div>
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-3"
                                        ...
                                        <a data-toggle="modal" data-target="#{{$stranger->face_id}}">
                                            <img class=""
                                                 ...
                                                 alt="{{$stranger->face_strname}}" height="70%"
        ...
        <div class="modal fade" id="{{$stranger->face_id}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form action="{{url('change_str')}}" method="post">
                        <div class="modal-body">
                            ...
                            <div class="col-sm-10">
                                <span>name:</span><input type="text" name="name" class="form-control" id=""
                                                         placeholder="{{$stranger->face_strname}}">

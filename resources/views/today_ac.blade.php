...
<div class="super-content RightMain" id="RightMain">
    <div class="superCtab">
        <div class="ctab-title clearfix"><h3>今日访客</h3></div>
        <div class="ctab-Main">
            <div class="ctab-Main-title">
                <ul class="clearfix">
                    <li class="cur"><a href="{{url('today_ac')}}">已识别访客</a></li>
                    <li><a href="{{url('today_str')}}">陌生访客</a></li>
                </ul>
            </div>
                        ...
                        <div class="row">
                            @foreach ($strangers as $stranger)
                                <div class="col-md-3" style="padding-top:6px;height: 200px;border: 0px">
                                    <img class="" src="data:image/jpeg;base64,{{base64_encode($stranger->face_path)}}" alt="{{$stranger->time}}" height="80%" style="padding: 4px;background-color: #fff;border: 1px solid #ddd;border-radius: 4px;">
                                    <br>
